  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#070707]/80 backdrop-blur-md animate-in fade-in">
      <div className="glass-panel rounded-3xl max-w-sm w-full overflow-hidden shadow-2xl border border-[#D8E6DF]/30 flex flex-col">
        ...
        {/* Header */}
        <div className="bg-[#0B2A1A] p-4 text-white flex items-center justify-between border-b border-[#D8E6DF]/20">
          <div className="flex items-center gap-2.5">
            <IoSwapHorizontal className="text-xl text-[#D8E6DF]" />
            <h3 className="font-extrabold text-base">Actualizar Tasas de Cambio</h3>
          </div>
          <button onClick={onClose} className="p-1.5 rounded-xl hover:bg-[#D8E6DF]/10 text-[#D8E6DF]">
        ...
        <div className="p-5 space-y-4 text-white">
          <div>
            <label className="block text-[10px] font-extrabold uppercase tracking-wider text-[#D8E6DF]/70 mb-1">
              TASA COP POR 1 USD ($)
            </label>
            <input
              type="number"
              ...
              className="w-full px-3.5 py-2.5 text-sm bg-[#070707] border border-[#D8E6DF]/20 rounded-xl font-extrabold text-[#D8E6DF] focus:outline-none focus:ring-2 focus:ring-[#10b981]"
            />
          </div>
        ...
        {/* Footer */}
        <div className="p-4 bg-[#0B2A1A] border-t border-[#D8E6DF]/20 flex items-center justify-between gap-3">
          <button onClick={onClose} className="text-xs font-bold text-[#D8E6DF]/70 px-3 hover:text-white">
            Cancelar
          </button>
          <button
            onClick={handleSave}
